...
public sealed class GetLastPromptHistoryTests : PromptHistoryControllerTestsBase
{
    ...
    public async Task GetLast_ReturnsBadRequest_WhenCountIsZero()
    {
        ...
        actionResult
            .Should()
            .BeBadRequestResult()
            .WithMessage("History count must be greater than zero");
    }
    ...
    public async Task GetLast_ReturnsBadRequest_WhenCountExceedsAvailable()
    {
        ...
        actionResult
            .Should()
            .BeBadRequestResult()
            .WithMessage("Requested 100 records, but only 50 are available");
    }
    ...
    public async Task GetLast_HandlesCancellationToken()
    {
        ...
        // Act & Assert
        await FluentActions
            .Awaiting(() => controller.GetLast(count, cts.Token))
            .Should()
