...
public class ApplicationErrorsExtensionsTests
{
    ...
    public void CreateValidationErrorIfAny_WithNoErrors_ReturnsNull()
    {
        ...
        // Act
        var result = ApplicationErrorsExtensions.CreateValidationErrorIfAny<string>(appErrors, domainErrors);
    ...
    {
        // Arrange
        var appErrors = new List<ApplicationError> { new ApplicationError("app error") };
        var domainErrors = new List<DomainError>();
    ...
    public void CreateValidationErrorIfAny_WithOnlyDomainErrorsList_ReturnsResult()
    {
        ...
        // Act
        var result = ApplicationErrorsExtensions.CreateValidationErrorIfAny<string>(domainErrors);
    ...
    public void CreateValidationErrorIfAny_WithOnlyAppErrorsList_ReturnsResult()
    {
        ...
        // Act
        var result = ApplicationErrorsExtensions.CreateValidationErrorIfAny<string>(appErrors);
    ...
    public void CollectErrors_WithFailedResult_AddsApplicationErrors()
    {
        // Arrange
        var errors = new List<ApplicationError>();
        var appError = new ApplicationError("fail");
