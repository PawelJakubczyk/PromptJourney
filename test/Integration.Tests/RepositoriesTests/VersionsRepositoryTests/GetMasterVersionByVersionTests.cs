...
public sealed class GetMasterVersionByVersionTests : RepositoryTestsBase
{
    ...
    public async Task GetMasterVersionByVersionAsync_WithExistingVersion_ShouldReturnVersion()
    {
        ...
        // Act
        var result = await VersionsRepository.GetMasterVersionByVersionAsync(version, CancellationToken);
    ...
    public async Task GetMasterVersionByVersionAsync_WithMultipleVersions_ShouldReturnCorrectVersion()
    {
        ...
        // Act
        var result = await VersionsRepository.GetMasterVersionByVersionAsync(targetVersion, CancellationToken);
