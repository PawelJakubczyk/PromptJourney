...
public interface IExampleLinksRepository
{
    ...
    Task<Result<List<MidjourneyStyleExampleLink>>> GetExampleLinksByID(StyleName styleName, CancellationToken cancellationToken);
    ...
    Task<Result<bool>> CheckExampleLinkExistsAsync(string Id, CancellationToken cancellationToken);
    ...
    Task<Result<MidjourneyStyleExampleLink>> DeleteExampleLinkAsync(string Id, CancellationToken cancellationToken);
