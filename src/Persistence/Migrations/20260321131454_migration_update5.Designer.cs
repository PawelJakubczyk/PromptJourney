...
namespace Persistence.Migrations
{
    ...
    [Migration("20260321131454_migration_update5")]
    partial class migration_update5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.MidjourneyStyleExampleLink", b =>
                {
                    b.HasOne("Domain.Entities.MidjourneyStyle", "MidjuorneyStyle")
                        .WithMany("MidjourneyExampleLinks")
                        .HasForeignKey("StyleName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.MidjourneyVersion", "MidjourneyMaster")
                        .WithMany()
                        .HasForeignKey("Version")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MidjourneyMaster");

                    b.Navigation("MidjuorneyStyle");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MidjourneyVersion", b =>
                {
                    ...
                    b.Navigation("MidjourneyProperties");
                });
